...
export function DashboardPageContent() {
  ...
  const calendarAddedCount = events.filter((event) => event.addedToCalendar).length;
      ...
      >
        ...
        <div className="relative mx-auto max-w-6xl">
          ...
          <p className="mt-4 max-w-2xl text-base text-zinc-400 sm:text-lg">
            Keep approvals moving, monitor upcoming launches, and align your team
            before demo day.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
            {dashboardStats.map((stat) => (
              <article
                key={stat.label}
                className="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-5 shadow-lg shadow-black/20"
              >
